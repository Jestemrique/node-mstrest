...
module.exports = class RestTopic extends RestUtil {
    ...
    /**
     * Establish aa session With MicroStrategy Library
     * 
     * @param {Object} params
     ...
     */
    login(params, shouldStoreSesion = true, useStoredCredentials = false) {
    ...
    /**
     * Terminate a session with MicroStrategy Library - using the uth token as parameter
     * 
